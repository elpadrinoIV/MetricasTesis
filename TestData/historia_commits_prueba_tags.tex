...
\begin{tikzpicture}[node distance=6mm and 10mm, common/.style={draw=green!50!black, rounded  corners, very thick, fill=green!50!white!50, font=\bfseries},minimum width=15mm, minimum height=10mm]
\tikzstyle{fakenode}=[]
