...
plot archivo_cantidad using ($2+$5+$6+$8):xtic(9) every ::1 ti "\\ft Código" ls 1, \
     archivo_cantidad using ($3+$5+$7+$8):xtic(9) every ::1 ti "\\ft UT" ls 2, \
     archivo_cantidad using ($4+$6+$7+$8):xtic("\\ft " . stringcolumn(9)) every ::1 ti "\\ft AT" ls 3
 
# set output proyecto . "/actividad_simultanea_porcentaje_sobre_at_ut_codigo.png"
set output "actividad_simultanea_porcentaje.png"
plot [:][0:100] archivo_cantidad using (($2+$5+$6+$8)/($2+$3+$4+$5+$6+$7+$8)*100):xtic(9) every ::1 ti "\\ft Código" ls 1, \
     archivo_cantidad using (($3+$5+$7+$8)/($2+$3+$4+$5+$6+$7+$8)*100):xtic(9) every ::1 ti "\\ft UT" ls 2, \
     archivo_cantidad using (($4+$6+$7+$8)/($2+$3+$4+$5+$6+$7+$8)*100):xtic("\\ft " . stringcolumn(9)) every ::1 ti "\\ft AT" ls 3
